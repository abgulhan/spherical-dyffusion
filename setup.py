...
extras["run"] = deps_list("xarray", "netCDF4", "dask", "einops", "hydra-core", "wandb")
...
extras["dev"] = deps_list(*[x.split("<")[0].split(">")[0] for x in _deps])
...
setup(
    name="spherical_dyffusion",
    version="0.0.1",  # expected format is one of x.y.z.dev0, or x.y.z.rc1 or x.y.z (no to dashes, yes to dots)
    description="Probabilistic Emulation of a Global Climate Model with Spherical DYffusion",
    ...
    keywords="machine learning climate modeling dyffusion forecasting spatiotemporal probabilistic diffusion model",
