...
def load_stepper(
    ...
    checkpoint_file = local_path_to_absolute_and_download_if_needed(checkpoint_file)
...
class InferenceConfig:
    ...
    def load_stepper(self, **kwargs) -> Union[SingleModuleStepper, MultiStepStepper]:
        ...
        if checkpoint_file.startswith("hf:"):
            checkpoint_file = local_path_to_absolute_and_download_if_needed(self.checkpoint_path)
        elif os.path.exists(checkpoint_file) and self.wandb_run_path is None:
