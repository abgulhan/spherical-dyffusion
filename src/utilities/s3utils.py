...
#     S3_ENDPOINT_URL = os.environ["S3_ENDPOINT_URL"] = "https://XYZ.edu"
#     S3_BUCKET_NAME = os.environ["S3_BUCKET_NAME"] = "my-data-and-results"
...
def download_s3_object(s3_file_path, local_file_path: str, throw_error: bool = True):
    ...
    try:
        ...
        try:
            ...
            log.warning(f"Failed to list files in directory: {e}")
        if throw_error:
